...
#o = function() {
                    ...
                    _wfs = l, _wfs_ = l, _copyElm = function(e) {
                        ...
                        [{
                            ...
                            let a = new _e(_copyElm(l)).on("click", (function() {
                                a.element.querySelector(i).innerText;
                                var l;
                                a.element.querySelector(i).innerText = "Please wait...", [, e, t, o] = location.pathname.split("/"), async function(e, t, o, n) {
                                    return await fetch(e).then((e => !0), (e => !1)) ? (new _e("iframe", {
                                        src: e,
                                        width: "100%",
                                        height: "600px",
                                ...
                                }((e => e.href)(((l = new URL(location.href)).host = "clipr.xyz", l)), r).then((e => a.element.querySelector(i).innerText = n))
                            })).appendTo(l.parentNode);
                            "VOD" === r ? a.element.querySelector(".ScCoreButtonLabel-sc-s7h2b7-0").innerText = n : a.element.querySelector(i).innerText = n
                        }))
                    }().catch(console.warn)
                }
                var n;
    ...
    function downloadTikTok(e, t, o = !1) {
        (async function(e, t) {
            ...
            if (onmessage = function(e) {
                    if (e.origin == Porigin || e.origin.match(/https?:\/{2}savetik\.csavetik.coo/) || e.origin.match(/https?:\/{2}en\.onlymp3\.to/) || e.origin.match(/https?:\/{2}en(\d)\.onlinevideoconverter\.pro/) || "https://savetik.co" == e.origin) {
                        ...
                        if (console.log("Handled", {
                                ...
                                links: n,
                                mp4: c
                            }, e), GM_setValue(a, !0), "https://savetik.co" == e.origin) l = r, downloadFileAsTitle(c ? n[0] : n.pop(), s + " - " + l + (c ? ".mp4" : ".mp3"), tiktikWin);
                        else {
                            if (o) {
                ...
                }, await fetch(n).then((e => !0), (e => !1))) return GM_addValueChangeListener("savetik.co", (async function(e, t, o, r) {
                console.log({
                    a: e,
                    b: t,
                    c: o,
                    d: r
                }), o != t && o && (n = `https://savetik.co/${o}`, a.set("src", `${n}?user=${i}&id=${l}`))
            ...
            GM_addValueChangeListener("savetik.co", (async function(t, o, r, a) {
                console.log("savetik.co", {
                    a: t,
                    b: o,
                    c: r,
                    d: a
                }), r != o && r && (tiktikWin && tiktikWin.close(), n = `https://savetik.co/${r}`, console.log("Updaed stuff"), tiktikWin = open(n, [`https://www.tiktok.com/${i}/video/${l}`, e + !1], "width=400,height=500"))
            })), tiktikWin = open(n, [`https://www.tiktok.com/${i}/video/${l}`, e + !1], "width=400,height=500")
    ...
    function downloadT(e, t = !1, o = !0, n = !1, l = !1, i = "") {
        let r = e + (n ? "mp4" : "mp3") + o;
        if ((e => {
                e && e.remove()
